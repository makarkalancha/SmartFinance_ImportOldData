...
--use MERGE if
MERGE INTO ITEM_DESC (CATEGORY_ID,DESCRIPTION1,DESCRIPTION2) VALUES(@food,'молоко','milk');
MERGE INTO ITEM_DESC (CATEGORY_ID,DESCRIPTION1,DESCRIPTION2) VALUES(@food,'сол огурцы','pickles');
