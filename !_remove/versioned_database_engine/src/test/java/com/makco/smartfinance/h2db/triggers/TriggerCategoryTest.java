...
public class TriggerCategoryTest {
    ...
    private static TriggerCategoryGroupTest triggerCategoryGroupTest = new TriggerCategoryGroupTest();
    ...
    public static void setUpClass() throws Exception {
        ...
        categoryGroupIdMain = triggerCategoryGroupTest.insert(categoryGroupType, "Main", "main category group");
        categoryGroupIdAnother = triggerCategoryGroupTest.insert(categoryGroupType, "Another", "another category group");
    }
