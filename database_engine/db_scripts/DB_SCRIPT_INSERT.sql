...
--use MERGE if
MERGE INTO ITEM_DESC (CATEGORY_ID,DESCRIPTION1,DESCRIPTION2) VALUES(2,'молоко','milk');
MERGE INTO ITEM_DESC (CATEGORY_ID,DESCRIPTION1,DESCRIPTION2) VALUES(2,'сол огурцы','pickles');
