...
public class TriggerInvoice extends AbstractTrigger {
    ...
    protected void prepareJsonForDeletion(Object[] oldRow) {
        ...
        rowJson.addProperty(Table.INVOICE.DEBIT_TOTAL.toString(),
                (BigDecimal) oldRow[Table.INVOICE.DEBIT_TOTAL.getColumnIndex()]);
        rowJson.addProperty(Table.INVOICE.CREDIT_TOTAL.toString(),
                (BigDecimal) oldRow[Table.INVOICE.CREDIT_TOTAL.getColumnIndex()]);
