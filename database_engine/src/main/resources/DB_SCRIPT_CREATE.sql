...
CREATE INDEX IF NOT EXISTS IDXACCNTGRPTPNM ON ACCOUNT_GROUP(TYPE,NAME);--because we search by TYPE,NAME
...
CREATE INDEX IF NOT EXISTS IDXCTGRGRPTPNM ON CATEGORY_GROUP(TYPE,NAME);--because we search by TYPE,NAME
...
CREATE INDEX IF NOT EXISTS IDXORGNM ON ORGANIZATION(NAME);--because we sort by NAME
...
CREATE INDEX IF NOT EXISTS IDXTAXNM ON TAX(NAME);--because we sort by NAME
