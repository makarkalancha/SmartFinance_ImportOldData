...
public class ItemDAOImpl_v2ForTest {
    ...
    public Item_v2 getItemById(Long id) throws Exception {
        ...
        Item_v2 item_v1 = null;
        try {
            session = TestPersistenceSession.openSession();
            session.beginTransaction();
            item_v1 = session.get(Item_v2.class, id);
...
//            CategoryGroup CategoryGroup = (CategoryGroup) session.load(CategoryGroup.class, id);
             ...
             */
            Item_v2 item_v1 = session.load(Item_v2.class, id);
    ...
    public void saveOrUpdateItem(Item_v2 item_v1) throws Exception {
    ...
    public void saveOrUpdateMultipleItem(List<Item_v2> item_v1_list) throws Exception {
        ...
        try {
            ...
            if it's in both Invoice_v1 and Item_v2 than saving is as follows:
            ...
            if "cascade = CascadeType.ALL" is in both Invoice_v1 and Item_v2 than
