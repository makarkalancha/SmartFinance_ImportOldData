 ...
 */
public class FamilyMemberDAOImpl_v1ForTest implements FamilyMemberDAO{
    private final static Logger LOG = LogManager.getLogger(FamilyMemberDAOImpl_v1ForTest.class);
