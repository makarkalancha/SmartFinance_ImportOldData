...
public class CategoryGroupCredit_v1 extends CategoryGroup_v1<CategoryCredit_v1> {
...
//    private SortedMap<Long, CategoryCredit> categories = new TreeMap<>();
    ...
    public CategoryGroupCredit_v1() {
    }

    public CategoryGroupCredit_v1(String name, String description) {
        this.name = name;
        this.description = description;
    }

    public SortedSet<CategoryCredit_v1> getDebitCategories() {
...
//    }
    ...
    @Override
    public Collection<CategoryCredit_v1> getCategories() {
        return this.categories;
    }

    @Override
    public void setCategories(Collection<CategoryCredit_v1> categories) {
    ...
    public boolean equals(Object other) {
        if (other instanceof CategoryGroupCredit_v1) {
            CategoryGroupCredit_v1 that = (CategoryGroupCredit_v1) other;
