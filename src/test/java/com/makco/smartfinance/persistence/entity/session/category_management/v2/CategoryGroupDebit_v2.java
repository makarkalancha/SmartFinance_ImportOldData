...
////    private SortedMap<Long, CategoryDebit> categories = new TreeMap<>();
    ...
    public CategoryGroupDebit_v2() {
    }

    public CategoryGroupDebit_v2(String name, String description) {
        this.name = name;
...
//    }
    ...
    public boolean equals(Object other) {
        if (other instanceof CategoryGroupDebit_v2) {
            CategoryGroupDebit_v2 that = (CategoryGroupDebit_v2) other;
