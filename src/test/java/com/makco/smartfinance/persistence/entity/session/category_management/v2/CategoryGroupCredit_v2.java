...
////    private SortedMap<Long, CategoryCredit> categories = new TreeMap<>();
    ...
    public CategoryGroupCredit_v2() {
    }

    public CategoryGroupCredit_v2(String name, String description) {
        this.name = name;
...
//    }
    ...
    public boolean equals(Object other) {
        if (other instanceof CategoryGroupCredit_v2) {
            CategoryGroupCredit_v2 that = (CategoryGroupCredit_v2) other;
